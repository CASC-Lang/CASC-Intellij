...
public class CASCVariableDeclarationImpl extends ASTWrapperPsiElement implements CASCVariableDeclaration {

  public CASCVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
