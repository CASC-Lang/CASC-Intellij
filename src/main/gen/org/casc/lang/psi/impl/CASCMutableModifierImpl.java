...
public class CASCMutableModifierImpl extends ASTWrapperPsiElement implements CASCMutableModifier {

  public CASCMutableModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CASCVisitor visitor) {
    visitor.visitMutableModifier(this);
  }
