...
public class CASCUnaryOperatorsImpl extends ASTWrapperPsiElement implements CASCUnaryOperators {

  public CASCUnaryOperatorsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CASCVisitor visitor) {
    visitor.visitUnaryOperators(this);
  }
