...
public class CASCLiteralExpressionImpl extends ASTWrapperPsiElement implements CASCLiteralExpression {

  public CASCLiteralExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
