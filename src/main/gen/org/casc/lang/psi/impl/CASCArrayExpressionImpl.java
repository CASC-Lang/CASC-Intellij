...
public class CASCArrayExpressionImpl extends ASTWrapperPsiElement implements CASCArrayExpression {

  public CASCArrayExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CASCArraySizeDeclaration getArraySizeDeclaration() {
    return findNotNullChildByClass(CASCArraySizeDeclaration.class);
  }
