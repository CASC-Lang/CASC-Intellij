...
public class CASCArrayDeclarationImpl extends ASTWrapperPsiElement implements CASCArrayDeclaration {

  public CASCArrayDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
