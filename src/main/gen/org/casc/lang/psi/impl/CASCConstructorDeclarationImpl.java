...
public class CASCConstructorDeclarationImpl extends ASTWrapperPsiElement implements CASCConstructorDeclaration {

  public CASCConstructorDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
