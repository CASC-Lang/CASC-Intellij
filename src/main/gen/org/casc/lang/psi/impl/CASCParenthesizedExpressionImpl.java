...
public class CASCParenthesizedExpressionImpl extends ASTWrapperPsiElement implements CASCParenthesizedExpression {

  public CASCParenthesizedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
