...
public class CASCMemberSuffixImpl extends ASTWrapperPsiElement implements CASCMemberSuffix {

  public CASCMemberSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CASCVisitor visitor) {
    visitor.visitMemberSuffix(this);
  }
