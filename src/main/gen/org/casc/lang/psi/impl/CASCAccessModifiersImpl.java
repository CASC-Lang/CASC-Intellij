...
public class CASCAccessModifiersImpl extends ASTWrapperPsiElement implements CASCAccessModifiers {

  public CASCAccessModifiersImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CASCVisitor visitor) {
    visitor.visitAccessModifiers(this);
  }
